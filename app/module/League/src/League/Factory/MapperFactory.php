...
class MapperFactory implements FactoryInterface
{
    ...
    public function getMapper($typ)
    {
        ...
        switch (strtolower($typ)) {
           ...
           case "season": $mapper = new Mapper\SeasonMapper();
                          break;
           case "league": $mapper = new Mapper\LeagueMapper();
                          break;           
           case "player": $mapper = new Mapper\PlayerMapper();
                          break;  
           case "match":  $mapper = new Mapper\MatchMapper();
                          break;        
