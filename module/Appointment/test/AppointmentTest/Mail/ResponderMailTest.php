 ...
 */
class ResponderMailTest extends PHPUnit_Framework_TestCase
{
    private $helper;
    private $obj;
    private $appointment;
    ...
    public function setUp()
    {
        ...
        $this->helper = $helper;
        $this->obj = new ResponderMail($helper->getMessageSrv(), $helper->getTransportSrv());
    ...
    public function  testGetMailBody()
    {
        ...
        $this->assertContains(MailTestHelper::TIME, $message);
        $this->assertContains(MailTestHelper::CONFIRM_STRING, $message);
    }
