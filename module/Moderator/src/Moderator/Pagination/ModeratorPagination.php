...
class ModeratorPagination
{
    ...
    {
        $repository = $entityManager->getRepository('Moderator\Entity\LeagueManager');

        $ormPagination = new ORMPaginator($repository->createQueryBuilder('leagueManager'));
