...
use League\Statistics\Games\PlayedGames;
use League\Statistics\Results as RESULTS;
use PHPUnit_Framework_TestCase;

class PlayedGamesTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testGetNumberOfGamesWithFourPoints()
    {
