...
class SupportRequest
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="\Support\Entity\SupportType", cascade={"persist"})
    ...
    /**
     * @ORM\ManyToOne(targetEntity="\Support\Entity\SupportSubject", cascade={"persist"})
     * @ORM\JoinColumn(name="subject", referencedColumnName="id", nullable=false)
     */
    private $subject;

    /**
     * @ORM\OneToMany(targetEntity="\Support\Entity\SupportMessage", mappedBy="request", cascade={"persist", "remove"})
     */
    private $messages;
